...
int main(string[] args)
{
    ...
    bool json;
    auto helpInformation = getopt(args, "m|major", "Version major number.",
            &major, // numeric
            ...
            &patch, // numeric
            "v|version",
            "Version as parsable  ('.' separated) version string. Ommited numbers will be considered 0.
             If json is enabled, a json representation is assumed (e.g. {\"version\": \"1.2.3\"}).",
